    ...
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            flex: 3,
            child: Text('Employee', style: AppStyles.semi13PrimaryDark()),
          ),
          Expanded(
            flex: 2,
            child: Text('Check In', style: AppStyles.semi13PrimaryDark()),
          ),
          Expanded(
            flex: 2,
            child: Text('Check Out', style: AppStyles.semi13PrimaryDark()),
          ),
          Expanded(
            flex: 2,
            child: Text('Hours', style: AppStyles.semi13PrimaryDark()),
          ),
          Expanded(
            flex: 2,
            child: Text('Status', style: AppStyles.semi13PrimaryDark()),
          ),
        ],
      ),
    );
