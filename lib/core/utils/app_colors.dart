...
class AppColors {
  ...
  /* ── Dark Mode Surfaces ── */
  static const Color darkBackgroundColor = Color(0xff030712);
  static const Color darkSurfaceColor = Color(0xff0B1329);
  static const Color darkSurfaceLightColor = Color(0xff1C2541);
  ...
  static const Color darkTextSubtle = Color(0xff475569);
  ...
  static const List<BoxShadow> shadowSm = [
    BoxShadow(offset: Offset(0, 1), blurRadius: 3, color: Color(0x140F2D6E)),
    BoxShadow(offset: Offset(0, 1), blurRadius: 2, color: Color(0x0F0F2D6E)),
  ];

  static const List<BoxShadow> shadowMd = [
    BoxShadow(offset: Offset(0, 4), blurRadius: 16, color: Color(0x1A0F2D6E)),
    BoxShadow(offset: Offset(0, 2), blurRadius: 6, color: Color(0x0F0F2D6E)),
  ];

  static const List<BoxShadow> shadowLg = [
    BoxShadow(offset: Offset(0, 8), blurRadius: 32, color: Color(0x240F2D6E)),
    BoxShadow(offset: Offset(0, 4), blurRadius: 12, color: Color(0x140F2D6E)),
  ];

  static const List<BoxShadow> shadowAccent = [
    BoxShadow(offset: Offset(0, 8), blurRadius: 24, color: Color(0x40C8A84B)),
  ];
